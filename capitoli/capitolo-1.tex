...
\begin{enumerate}
\item \textbf{Gli individui e le interazioni al di là dei processi e degli strumenti.}
\tab \lab{} infatti predilige una comunicazione.........
\item \textbf{Il software funzionante al di là della documentazione esaustiva.}
\item \textbf{La collaborazione col cliente al di là della negoziazione dei contratti.}
\item \textbf{Rispondere al cambiamento piuttosto che seguire un piano.}
\end{enumerate}
