...
\begin{itemize}
\item \textbf{RFK\textunderscore F\textunderscore Ob1 - Il sistema deve permettere la lettura di un codice a barre}: 
\item \textbf{RFK\textunderscore F\textunderscore Ob2 - Il sistema deve attivare il lettore quando rileva un utente nelle vicinanze}:
\item \textbf{RFK\textunderscore Q\textunderscore Ob1 - Il modulo di lettura deve essere contenuto in un involucro stampato in 3D}:
\item \textbf{RFK\textunderscore Q\textunderscore Op1 - L'involucro esterno deve essere modulare ed espandibile per versioni successive}:
\end{itemize}
...
\begin{itemize}
\item \textbf{RPO\textunderscore F\textunderscore Ob1 - L'applicazione deve permettere di visualizzare l'elenco degli utenti autorizzati}:
\item \textbf{RPO\textunderscore F\textunderscore Ob2 - L'applicazione deve permettere di gestire le autorizzazioni}:
\item \textbf{RPO\textunderscore F\textunderscore Ob2.1 - L'applicazione deve permettere di eliminare un'autorizzazione}:
\item \textbf{RPO\textunderscore F\textunderscore De1 - L'applicazione deve presentare un'interfaccia grafica completamente scalabile}:
\end{itemize}
