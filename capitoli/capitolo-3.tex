...
La configurazione del modulo di lettura dei codici a barre prevedeva la presenza di una chiave passepartout, ovvero un codice a barre, in grado di aprire la porta indipendentemente dalle autorizzazioni nel cloud. Questo permette di aprire la porta anche nel caso in cui la connessione ad internet sia assente.
