...
Il nostro compito era di soddisfare questo requisito in modo che la comunicazione fosse il più rapida possibile.
...
L'applicazione web per la gestione delle autorizzazioni è composta da un lato frontend e da un lato backend. La prima parte è composta dall'interfaccia grafica e dalle componenti lato client, mentre la seconda contiene il database e le funzioni per l'elaborazione della risposta alle chiamate http da parte della centralina.

\subsubsection{Interfaccia grafica}

\begin{figure}[H]
	\begin{center}
	\includegraphics[scale=0.4]{immagini/accessi_gestionale.png}
